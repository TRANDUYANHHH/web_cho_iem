...
yesBtn.addEventListener("click", () => {
  responseText.textContent = "Heheee. Anh cũm iu emm 💖 💞";
  gif.src =
  ...
  nextBtn.style.backgroundColor = "#ff4d6d";
  nextBtn.style.color = "white";

  document.querySelector(".container").appendChild(nextBtn);

  // Khi bấm nút mới → chuyển trang
  nextBtn.addEventListener("click", () => {
    window.location.href = "ques.html"; // đổi tên nếu file bạn khác
  });
});
